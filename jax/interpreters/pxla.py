...
def shard_args(devices: Sequence[xb.xla_client.Device],
               ...
               args) -> Sequence[Union[Any, Sequence[xb.xla_client.Buffer]]]:
...
PxlaResultHandler = Callable[..., Callable[
    [Union[List[xb.xla_client.Buffer], Any]], Any]]
  ...
  def __call__(self, *args):
    ...
    if dispatch.needs_check_special():
      for bufs in out_bufs:
        if xb.use_sharded_buffer and isinstance(bufs, xb.ShardedBuffer):
          bufs = cast(xb.ShardedBuffer, bufs).get_device_buffers()
